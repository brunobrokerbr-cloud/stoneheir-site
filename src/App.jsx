...
const IMG = {
  heroHome: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1920&q=80",
  heroStone: "https://images.unsplash.com/photo-1551836022-4c4c79ecde51?w=1920&q=80",
  heroAbout: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=1920&q=80",
  heroContact: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=1920&q=80",
  heroServices: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1920&q=80",
  heroBlog: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=1920&q=80",
  aboutTeam: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&q=80",
  aboutOffice: "https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=800&q=80",
  city1: "https://images.unsplash.com/photo-1483729558449-99ef09a8c325?w=800&q=80",
  city2: "https://images.unsplash.com/photo-1554995207-c18c203602cb?w=800&q=80",
};
    ...
    <section style={{background:C.ds,minHeight:"100vh"}}>
      ...
      <div style={{maxWidth:900,margin:"0 auto",padding:"0 40px 80px"}}>
        ...
        <div style={{textAlign:"center",padding:"48px 0",borderTop:`1px solid ${C.g}22`}}>
          ...
          <div style={{display:"inline-block",padding:"12px 32px",background:C.g,fontFamily:serif,fontSize:14,fontWeight:600,color:C.ds,cursor:"pointer",letterSpacing:"0.05em"}}>Solicitar Demonstração</div>
        </div>
      </div>
    </section>
  );
    ...
    <section style={{background:C.ds,minHeight:"100vh"}}>
      ...
      <div style={{maxWidth:900,margin:"0 auto",padding:"0 40px 80px"}}>
        ...
        <div style={{padding:40,background:C.ch,borderRadius:8,border:`1px solid ${C.g}15`,textAlign:"center"}}>
          ...
          <p style={{fontFamily:serif,fontSize:14,color:C.wg,lineHeight:1.7,maxWidth:600,margin:"0 auto 24px"}}>
            A Stoneheir é a empresa de inteligência do grupo Realty Concierge — a rede de licenciamento imobiliário premium. Nossa independência editorial garante credibilidade; nossa conexão com a rede garante acesso a dados reais de mercado.
          </p>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:24,maxWidth:500,margin:"0 auto"}}>
            <div style={{padding:20,background:C.ds,borderRadius:4}}>
              <div style={{fontFamily:display,fontSize:14,fontWeight:700,letterSpacing:"0.15em",color:C.ow,marginBottom:4}}>STONEHEIR</div>
              <div style={{fontFamily:mono,fontSize:8,color:C.g}}>INTELIGÊNCIA</div>
            </div>
            <div style={{padding:20,background:C.ds,borderRadius:4}}>
              <div style={{fontFamily:display,fontSize:14,fontWeight:700,letterSpacing:"0.15em",color:C.ow,marginBottom:4}}>REALTY CONCIERGE</div>
              <div style={{fontFamily:mono,fontSize:8,color:C.g}}>OPERAÇÃO</div>
            </div>
          </div>
        </div>
      </div>
